...
namespace gTontine
{
    public partial class frmPrincipal : Form
    {
        ...
        {
            frmChoixRemboursement f = new frmChoixRemboursement();
            //frmAmendes f = new frmAmendes();
            //frmMotif f = new frmMotif();
            f.ShowDialog();
        }
          ...
          void Chargement( )
        {
            ...
            label2.Text = ClasseGenerale.gNomAssociation;
        }
        ...
        {
            frmChoixprets f = new frmChoixprets();
            f.ShowDialog();
        ...
        private void button4_Click_1(object sender, EventArgs e)
        {
            ...
            frmChoixFonddecaisse f = new frmChoixFonddecaisse();
            f.ShowDialog();
        }
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            frmchoixepargne f = new frmchoixepargne();
            f.ShowDialog();
        }

        private void button11_Click(object sender, EventArgs e)
        {
            frmAssociation f = new frmAssociation();
            f.ShowDialog();
        }

        private void button13_Click(object sender, EventArgs e)
        {
            frmChoixTontine f = new frmChoixTontine();
            f.ShowDialog();
        }
    }
}
